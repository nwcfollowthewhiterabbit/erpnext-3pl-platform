...
| --- | --- | --- |
| Receiving Notices | <https://erpnext.77.237.244.169.sslip.io/client/receiving-notice/list> | список входящих заявок клиента |
| New Receiving Notice | <https://erpnext.77.237.244.169.sslip.io/client/receiving-notice/new> | создание заявки на завоз товара |
| Products | <https://erpnext.77.237.244.169.sslip.io/client/products/list> | карточки товаров клиента |
| Product Imports | <https://erpnext.77.237.244.169.sslip.io/client/product-import/list> | загрузка CSV/XLSX товаров |
| Product Export | <https://erpnext.77.237.244.169.sslip.io/client/product-export> | выгрузка товаров и шаблон импорта |
| Inventory | <https://erpnext.77.237.244.169.sslip.io/client/inventory/list> | текущие остатки клиента |
| Shipment Requests | <https://erpnext.77.237.244.169.sslip.io/client/shipment-request/list> | заявки клиента на отгрузку |
| New Shipment Request | <https://erpnext.77.237.244.169.sslip.io/client/shipment-request/new> | создание заявки на отгрузку |
| Shipment Tracking | <https://erpnext.77.237.244.169.sslip.io/client/shipment-tracking> | статусы отгрузок |
| Discrepancies | <https://erpnext.77.237.244.169.sslip.io/client/discrepancies> | расхождения по приемке |
| Discrepancy Instructions | <https://erpnext.77.237.244.169.sslip.io/client/discrepancy-instruction/list> | инструкции клиента по расхождениям |
...
<https://erpnext.77.237.244.169.sslip.io/client/products/list>
...
- Receiving Notices: <https://erpnext.77.237.244.169.sslip.io/client/receiving-notice/list>
- Products: <https://erpnext.77.237.244.169.sslip.io/client/products/list>
- Product Imports: <https://erpnext.77.237.244.169.sslip.io/client/product-import/list>
- Product Export: <https://erpnext.77.237.244.169.sslip.io/client/product-export>
- Inventory: <https://erpnext.77.237.244.169.sslip.io/client/inventory/list>
- Shipment Requests: <https://erpnext.77.237.244.169.sslip.io/client/shipment-request/list>
...
- Discrepancy Instructions: <https://erpnext.77.237.244.169.sslip.io/client/discrepancy-instruction/list>
...
1. Открыть <https://erpnext.77.237.244.169.sslip.io/client/products/list>.
...
1. Открыть <https://erpnext.77.237.244.169.sslip.io/client/product-export>.
...
3. Заполнить строки:
   ...
   - `status`;
   - `notes`.
4. Открыть <https://erpnext.77.237.244.169.sslip.io/client/product-import/list>.
...
1. Открыть <https://erpnext.77.237.244.169.sslip.io/client/receiving-notice/new>.
...
1. Открыть <https://erpnext.77.237.244.169.sslip.io/client/discrepancies>.
2. Найти discrepancy по своему notice.
3. Открыть <https://erpnext.77.237.244.169.sslip.io/client/discrepancy-instruction/list>.
...
1. Открыть <https://erpnext.77.237.244.169.sslip.io/client/shipment-request/new>.
...
- клиент видит status в <https://erpnext.77.237.244.169.sslip.io/client/shipment-tracking>.
...
1. Открыть <https://erpnext.77.237.244.169.sslip.io/client/inventory/list>.
...
1. Открыть клиентский Inventory: <https://erpnext.77.237.244.169.sslip.io/client/inventory/list>.
2. Открыть Receiving Notices: <https://erpnext.77.237.244.169.sslip.io/client/receiving-notice/list>.
3. Открыть Shipment Requests: <https://erpnext.77.237.244.169.sslip.io/client/shipment-request/list>.
4. Открыть Products: <https://erpnext.77.237.244.169.sslip.io/client/products/list>.
...
| --- | --- | --- | --- |
| 1 | Клиент | Receiving Notices | <https://erpnext.77.237.244.169.sslip.io/client/receiving-notice/list> |
| 2 | Клиент | New Receiving Notice | <https://erpnext.77.237.244.169.sslip.io/client/receiving-notice/new> |
| 3 | Клиент | Products | <https://erpnext.77.237.244.169.sslip.io/client/products/list> |
| 4 | Клиент | Product Imports | <https://erpnext.77.237.244.169.sslip.io/client/product-import/list> |
| 5 | Клиент | Product Export | <https://erpnext.77.237.244.169.sslip.io/client/product-export> |
| 6 | Клиент | Inventory | <https://erpnext.77.237.244.169.sslip.io/client/inventory/list> |
| 7 | Клиент | Shipment Requests | <https://erpnext.77.237.244.169.sslip.io/client/shipment-request/list> |
| 8 | Клиент | New Shipment Request | <https://erpnext.77.237.244.169.sslip.io/client/shipment-request/new> |
| 9 | Клиент | Discrepancies | <https://erpnext.77.237.244.169.sslip.io/client/discrepancies> |
| 10 | Клиент | Discrepancy Instructions | <https://erpnext.77.237.244.169.sslip.io/client/discrepancy-instruction/list> |
