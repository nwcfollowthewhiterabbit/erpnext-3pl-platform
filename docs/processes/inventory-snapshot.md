...
This boundary is intentional: showing inventory immediately after client notice submission would make the client UI display stock before the warehouse physically receives and verifies the goods.
