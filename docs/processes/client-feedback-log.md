...
- Shipment requests are implemented as portal MVP records and now create draft Pick Lists for structured item rows. Full picking execution, packing, dispatch automation, and shipment tracking remain open.
